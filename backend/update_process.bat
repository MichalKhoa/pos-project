...
:: 3. Run database schema auto-migration
echo Verifying and updating database schema...
cd /d %~dp0
.\venv\Scripts\python.exe -c "from database import engine, Base; Base.metadata.create_all(bind=engine); print('Database schema OK')"
