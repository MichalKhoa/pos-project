# Frontend Setup Rules & Design System — Himmel POS

This setup rules document defines the UI, styling, responsiveness, touch ergonomics, and code discipline guidelines for the Himmel POS frontend.
...
- **No Text Wrapping in Buttons**: All button labels and chips MUST set `white-space: nowrap` and `flex-shrink: 0` to prevent multi-line text height expansion.
