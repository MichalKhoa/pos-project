# Eet Popis Rozhrani V1.1

*Converted from `EET_popis_rozhrani_v1.1.pdf` using pdftotext*
...
Soubory obsahující definici XML schematu a webové služby (WSDL), které formálně popisují
...
KÓDOVÁNÍ DATOVÝCH POLOŽEK .....................................................................................14
PŘEHLED STRUKTURY DATOVÝCH ZPRÁV ...........................................................................14
DATOVÁ ZPRÁVA EVIDOVANÉ TRŽBY .................................................................................17
XML formát e-tržby ...................................................................................................... 18
Přehled položek datové zprávy o evidované tržbě .......................................................... 18
Podrobný popis položek e-tržby ................................................................................... 18
Příklad e-tržby............................................................................................................. 23

POTVRZOVACÍ DATOVÁ ZPRÁVA ......................................................................................24

XML formát potvrzení .................................................................................................. 24
Přehled datových položek potvrzení ............................................................................. 25
Příklad potvrzení ......................................................................................................... 27
Seznam kódů a textů varování ...................................................................................... 27

CHYBOVÁ DATOVÁ ZPRÁVA ............................................................................................ 28

XML formát chyby ....................................................................................................... 28
Přehled datových položek chyby .................................................................................. 28
Příklad chyby .............................................................................................................. 30
Seznam chybových kódů a chybových zpráv ................................................................. 31

4

JEDNOZNAČNÝ KÓD TRŽBY – URČENÍ UNIKÁTNOSTI DANÉ TRŽBY ............................ 32

5

UPŘESNĚNÍ XML ZPRÁVY VE TVARU SOAP A JEJÍ ZABEZPEČENÍ ................................ 33
5.1
5.2
5.3
5.4

ŠIFROVÁNÍ KOMUNIKACE PROTOKOLEM HTTPS .................................................................33
PODPIS DATOVÝCH ZPRÁV EVIDOVANÝCH TRŽEB ................................................................ 33
ELEKTRONICKÝ PODPIS POTVRZOVACÍCH DATOVÝCH ZPRÁV..................................................34
POMOCNÉ TECHNICKÉ INFORMACE PRO TRASOVÁNÍ ........................................................... 34
...
soubory WSDL a XSD. rozhraní je číslována dvojicí čísel: hlavní (první) a vedlejší (druhé), např.
1.0, 1.1, 1.2 atd. Hlavní číslo verze rozhraní je součástí URL adresy ve všech cílových prostředích
(např. v4 pro verzi 4.x). Změny v rozhraní jsou zveřejňovány následujícím způsobem:
1.
...
WWW služeb dle specifikace publikované http://www.oasisopen.org/committees/wss/
...
Popis struktury XML dokumentu pomocí XML Schema (XML Schema
Definition)
...
KOMUNIKAČNÍ SCÉNÁŘ ZASÍLÁNÍ DATOVÝCH ZPRÁV
...
2. Cílovém prostředí. Prostředí je učeno adresou webové služby, na kterou byla datová
...
2. kontrola na konkrétní XML schema (*.xsd) datové zprávy evidované tržby, které obsahuje
...
rozumíme regulární výraz ve smyslu XML schematu, který přesně definuje požadovanou syntaxi
...
^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-5][0-9a-fA-F]{3}-[89abAB][0-9a-fAF]{3}-[0-9a-fA-F]{12}$
...
poplatníka alfanumerickými znaky a vybranými speciálními znaky. Tento kód je tvořen
alfanumerickými znaky a vybranými speciálními znaky.
...
V následujícím textu uvádíme příklad XML elementu <Trzba> zasílaném v běžném produkčním
módu:
...
Ano
pok
Příznak neprodukčního prostředí
Ne
test
Kód varování
Ne
kod_varov )**
Textový popis varování
Ne
Varovani )**
...
propustných chyb:
<tns:Odpoved>
<tns:Hlavicka uuid_zpravy="123e4567-e89b-42d3-a456426655440000"
...
Z důvodu konzistence všech datových zpráv jsou povolené znaky v dolní ASCII sadě XML
povolených znaků, tj. jejich dekadické kódy mají hodnoty 9, 10, 13 nebo od 32 do 126. To
znamená, že textový popis chyby nepoužívá používat diakritiku.
Délka: max. 100 znaků.
...
JEDNOZNAČNÝ KÓD TRŽBY – URČENÍ UNIKÁTNOSTI DANÉ TRŽBY
...
Pokud nebude nepovinná položka uvedena, musí do texu vstupovat jako prázdný řetězec ("").
Příklad:
...
UPŘESNĚNÍ XML ZPRÁVY VE TVARU SOAP A JEJÍ ZABEZPEČENÍ

Rozhraní webové služby je formálně definováno formou WSDL (Web Services Description
Language). WSDL dokument odkazuje na příslušný dokument XML Schema, který popisuje
vlastní XML strukturu e-tržby. XML struktura e-tržby je jediným obsahem SOAP elementu
<soap:Body>.
...
zařízení musí v rámci navázání spojení TLS spojení (TLS handshake) se společným technickým
zařízením povinně kontrolovat platnost TLS certifikátu serveru, zda byl vystaven důvěryhodnou
autoritou a zda se shoduje jméno, na které byl vydán, s adresou společného technického zařízení.
...
Schema (XSD). Elektronický podpis musí být realizován dle standardu XML Signature Syntax and
...
"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-soap-message-security1.0#Base64Binary") ve formátu X509v3 (typ "http://docs.oasisopen.org/wss/2004/01/oasis-200401-wss-x509-token-profile-1.0#X509v3").
...
chybová datová zpráva, některé technické chyby) uvádět na následující HTTP hlavičku:
...
aby výrobce pokladního zařízení měli možnost tuto hodnotu logovat nebo uložit a použít ji, pokud
