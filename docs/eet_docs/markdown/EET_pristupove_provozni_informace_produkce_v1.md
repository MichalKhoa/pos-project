# Eet Pristupove Provozni Informace Produkce V1

*Converted from `EET_pristupove_provozni_informace_produkce_v1.pdf` using pdftotext*
...
Limit počtu vydávaných certifikátů: maximálně 10 certifikátů na den a provozovnu
(ochrana proti záměrnému přetížení systému).
...
Pro elektronický podpis potvrzovacích datových zpráv je použit systémový certifikát od
certifikační autority SSSVD. Použitý systémový certifikát je vydán s atributem

O = Generální finanční ředitelství
Podpisový certifikát produkčního prostředí se může kdykoliv změnit, vždy ale budou
zachovány bezpečnostní atributy (platný systémový certifikát s nastavenou položkou O =
Generální finanční ředitelství). Pro zajištění maximální ochrany dat evidovaných tržeb je
doporučeno při zpracování odpovědi kontrolovat tyto atributy podpisového certifikátu.
...
Minimální datum a čas přijetí tržby na produkčním prostředí: 01.01.2027, 20:00 (před
