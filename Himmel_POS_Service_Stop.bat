...
echo ========================================================
echo   Stopping Himmel POS Background Service and Processes
echo ========================================================
echo.

REM 1. Stop Task Scheduler Service Task if running
echo [1/3] Terminating scheduled task 'HimmelPOSBackend'...
schtasks /end /tn "HimmelPOSBackend" >nul 2>&1

REM 2. Stop NSSM/Windows Service if installed
...
REM 3. Terminate active backend python.exe instances
