...
title Himmel POS - Developer Debug Mode
echo ========================================================
echo   Starting Himmel POS - DEBUG MODE (Hot Reloading)
echo ========================================================
echo.
...
echo   - Frontend live on: http://localhost:5173
echo   - Terminals remain open for live logging
echo ========================================================
